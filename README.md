...
개인 작업으로 필요한 기능과 방향을 정하고, 코드를 실행하며 결과를 확인했습니다. 생성형 AI는 코드 생성·리뷰, 라이브러리 사용법 학습, HTML 구조 이해와 오류 원인 탐색에 활용했습니다. 게임의 디자인·코드 초안에도 AI의 도움을 받았고, 직접 문구와 배치 등을 수정했습니다.

공개용 파일 정리에는 AI 코딩 도구를 추가 활용했습니다. 오프라인 예시, 함수 분리, 검증 코드와 개인정보 제거는 이번 포트폴리오 정리 단계에서 수정 작업을 거쳤으며, 최초 프로젝트에서 수행한 내용과 각 설명에서 구분했습니다. 
